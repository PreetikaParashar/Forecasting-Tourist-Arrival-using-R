...
data_2016 <- read_csv("/2016_brooklyn.csv")
data_2017 <- read_csv("/2017_brooklyn.csv")
data_2018 <- read_csv("/2018_brooklyn.csv")
data_2019 <- read_csv("/2019_brooklyn.csv")
data_2020 <- read_csv("/2020_brooklyn.csv")
...
saveRDS(list(model=final_mod, data=lm_data), file='final.RDS') 
